          ...
          <div className="bg-white rounded-lg overflow-hidden border border-gray-300">
            ...
            <div className="relative border-b border-gray-200">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border-0 focus:outline-none text-black placeholder-gray-400"
            ...
            <div className="relative border-b border-gray-200">
              ...
              <input
                ...
                className="w-full pl-10 pr-20 py-3 border-0 focus:outline-none text-black placeholder-gray-400"
